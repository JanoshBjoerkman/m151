...
CREATE TABLE IF NOT EXISTS `Ferienpass`.`Kurstag` (
  ...
  `Klasse_min` INT NULL,
  `Klasse_max` INT NULL,
  `Anzahl_Helfer` INT NOT NULL DEFAULT 0,
  `Kurs_ID` INT NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_Kurstag_Kurs1_idx` (`Kurs_ID` ASC),
  INDEX `fk_Kurstag_Klasse1_idx` (`Klasse_min` ASC),
  INDEX `fk_Kurstag_Klasse2_idx` (`Klasse_max` ASC),
  ...
  CONSTRAINT `fk_Kurstag_Klasse1`
    FOREIGN KEY (`Klasse_min`)
    REFERENCES `Ferienpass`.`Klasse` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Kurstag_Klasse2`
    FOREIGN KEY (`Klasse_max`)
    REFERENCES `Ferienpass`.`Klasse` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
