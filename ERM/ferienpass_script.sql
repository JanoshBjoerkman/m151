...
CREATE TABLE IF NOT EXISTS `Ferienpass`.`Event` (
  ...
  `Phase_1_start` DATETIME NOT NULL,
  `Phase_1_ende` DATETIME NOT NULL,
  `Phase_2_start` DATETIME NOT NULL,
  `Phase_2_ende` DATETIME NOT NULL,
